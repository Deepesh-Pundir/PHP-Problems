            ...
            if(mysqli_num_rows($result1)>0){
                ...
                ?>
                 ...
                 if($page>1){
                     ...
                     echo '<li><a href="Problem11(Pagination).php?page='.($page-1).'">&lt Prev &gt</a></li>';
                 }
                 echo '<span>|</sapn>';
                  if($page<$total_page){

                       echo '<li><a href="Problem11(Pagination).php?page='.($page+1).'">&lt Next &gt</a></li>';
                   }

                // if($page==1)
                // {
                //     echo '<li><a href="Problem11(Pagination).php?page='.(1).'">&lt Prev &gt</a></li>';
                // }
                // else{
                //     echo '<li><a href="Problem11(Pagination).php?page='.($page-1).'">&lt Prev &gt</a></li>';
                // }
                ...
                // if($page>=$total_page)
                // {
                //     echo '<li><a href="Problem11(Pagination).php?page='.($total_page).'">&lt Next &gt</a></li>';
                // }
                // else{
                //     echo '<li><a href="Problem11(Pagination).php?page='.($page+1).'">&lt Next &gt</a></li>';
                // }
